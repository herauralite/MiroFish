...
class AuraliteWorldService:
    ...
    def _ensure_milestone_03_shape(self, world: dict) -> dict:
        ...
        for household in world.get('households', []):
            ...
            household['social_context'].setdefault('support_fatigue_index', 0.0)
        ...
        for person in world.get('persons', []):
            ...
            for tie in person.get('social_ties', []):
                ...
                tie.setdefault('support_usefulness', 0.64 if tie_type == 'household' else 0.56 if tie_type == 'coworker' else 0.5)
                tie.setdefault('support_capacity', 0.68 if tie_type == 'household' else 0.58 if tie_type == 'coworker' else 0.5)
                tie.setdefault('support_fatigue', 0.12)
                tie.setdefault('failed_support_attempts', 0)
                tie.setdefault('successful_support_ticks', 0)
                tie.setdefault('strain_transfer_memory', 0.0)
            person.setdefault('social_context', {})
            person['social_context'].setdefault('support_capacity_index', 0.5)
            person['social_context'].setdefault('relationship_usefulness_index', 0.5)
            person['social_context'].setdefault('support_fatigue_index', 0.0)
            person['social_context'].setdefault('failed_support_attempts', 0)
            ...
            person['state_summary'].setdefault('support_capacity_index', person['social_context'].get('support_capacity_index', 0.5))
            person['state_summary'].setdefault('relationship_usefulness_index', person['social_context'].get('relationship_usefulness_index', 0.5))
            person['state_summary'].setdefault('support_fatigue_index', person['social_context'].get('support_fatigue_index', 0.0))
        ...
        world['city']['world_metrics']['local_vs_broad_pressure_split'].setdefault('topology_drag_soak_intensity', 0.0)
        world['city']['world_metrics']['local_vs_broad_pressure_split'].setdefault('topology_support_soak_intensity', 0.0)
        world['city']['world_metrics']['local_vs_broad_pressure_split'].setdefault('topology_support_alignment_signal', 0.0)
    ...
    def _sync_reporting_scenario_state(self, world: dict) -> dict:
        ...
        for artifact_key in ('scenario_digest', 'operator_brief', 'scenario_handoff'):
            ...
            artifact.setdefault('review_delegation_readiness_state', run_outcome.get('review_delegation_readiness_state', {}))
            artifact.setdefault('operator_review_delegation_readiness_evidence', run_outcome.get('operator_review_delegation_readiness_evidence', {}))
            artifact.setdefault('review_execution_readiness_state', run_outcome.get('review_execution_readiness_state', {}))
            artifact.setdefault('operator_review_execution_readiness_evidence', run_outcome.get('operator_review_execution_readiness_evidence', {}))
            artifact.setdefault('review_intervention_commitment_readiness_state', run_outcome.get('review_intervention_commitment_readiness_state', {}))
            artifact.setdefault('operator_review_intervention_commitment_evidence', run_outcome.get('operator_review_intervention_commitment_evidence', {}))
            artifact.setdefault('review_intervention_deployment_readiness_state', run_outcome.get('review_intervention_deployment_readiness_state', {}))
            artifact.setdefault('operator_review_intervention_deployment_evidence', run_outcome.get('operator_review_intervention_deployment_evidence', {}))
            artifact.setdefault('review_intervention_effect_reliability_state', run_outcome.get('review_intervention_effect_reliability_state', {}))
            artifact.setdefault('operator_review_intervention_effect_reliability_evidence', run_outcome.get('operator_review_intervention_effect_reliability_evidence', {}))
            artifact.setdefault('review_intervention_outcome_confidence_state', run_outcome.get('review_intervention_outcome_confidence_state', {}))
            artifact.setdefault('operator_review_intervention_outcome_confidence_evidence', run_outcome.get('operator_review_intervention_outcome_confidence_evidence', {}))
            artifact.setdefault('review_intervention_claim_durability_state', run_outcome.get('review_intervention_claim_durability_state', {}))
            artifact.setdefault('operator_review_intervention_claim_durability_evidence', run_outcome.get('operator_review_intervention_claim_durability_evidence', {}))
            artifact.setdefault('review_intervention_generalizability_state', run_outcome.get('review_intervention_generalizability_state', {}))
            artifact.setdefault('operator_review_intervention_generalizability_evidence', run_outcome.get('operator_review_intervention_generalizability_evidence', {}))
            artifact.setdefault('review_intervention_transferability_state', run_outcome.get('review_intervention_transferability_state', {}))
            artifact.setdefault('operator_review_intervention_transferability_evidence', run_outcome.get('operator_review_intervention_transferability_evidence', {}))
            artifact.setdefault('review_intervention_scalability_state', run_outcome.get('review_intervention_scalability_state', {}))
            artifact.setdefault('operator_review_intervention_scalability_evidence', run_outcome.get('operator_review_intervention_scalability_evidence', {}))
            artifact.setdefault('review_intervention_robustness_state', run_outcome.get('review_intervention_robustness_state', {}))
            artifact.setdefault('operator_review_intervention_robustness_evidence', run_outcome.get('operator_review_intervention_robustness_evidence', {}))
            artifact.setdefault('review_intervention_adaptability_state', run_outcome.get('review_intervention_adaptability_state', {}))
            artifact.setdefault('operator_review_intervention_adaptability_evidence', run_outcome.get('operator_review_intervention_adaptability_evidence', {}))
            artifact.setdefault('review_intervention_sustainability_state', run_outcome.get('review_intervention_sustainability_state', {}))
            artifact.setdefault('operator_review_intervention_sustainability_evidence', run_outcome.get('operator_review_intervention_sustainability_evidence', {}))
            artifact.setdefault('review_intervention_repeatability_state', run_outcome.get('review_intervention_repeatability_state', {}))
            artifact.setdefault('operator_review_intervention_repeatability_evidence', run_outcome.get('operator_review_intervention_repeatability_evidence', {}))
            artifact.setdefault('review_intervention_reliability_state', run_outcome.get('review_intervention_reliability_state', {}))
            artifact.setdefault('operator_review_intervention_reliability_evidence', run_outcome.get('operator_review_intervention_reliability_evidence', {}))
            artifact.setdefault('review_intervention_predictability_state', run_outcome.get('review_intervention_predictability_state', {}))
            artifact.setdefault('operator_review_intervention_predictability_evidence', run_outcome.get('operator_review_intervention_predictability_evidence', {}))
            artifact.setdefault('review_intervention_dependability_state', run_outcome.get('review_intervention_dependability_state', {}))
            artifact.setdefault('operator_review_intervention_dependability_evidence', run_outcome.get('operator_review_intervention_dependability_evidence', {}))
            artifact.setdefault('review_intervention_assurability_state', run_outcome.get('review_intervention_assurability_state', {}))
            ...
            artifact.setdefault('compact_historical_delegation_readiness_lines', run_outcome.get('compact_historical_delegation_readiness_lines', []))
            artifact.setdefault('compact_historical_execution_readiness_lines', run_outcome.get('compact_historical_execution_readiness_lines', []))
            artifact.setdefault('compact_historical_intervention_commitment_lines', run_outcome.get('compact_historical_intervention_commitment_lines', []))
            artifact.setdefault('compact_historical_intervention_deployment_lines', run_outcome.get('compact_historical_intervention_deployment_lines', []))
            artifact.setdefault('compact_historical_intervention_effect_reliability_lines', run_outcome.get('compact_historical_intervention_effect_reliability_lines', []))
            artifact.setdefault('compact_historical_intervention_outcome_confidence_lines', run_outcome.get('compact_historical_intervention_outcome_confidence_lines', []))
            artifact.setdefault('compact_historical_intervention_claim_durability_lines', run_outcome.get('compact_historical_intervention_claim_durability_lines', []))
            artifact.setdefault('compact_historical_intervention_generalizability_lines', run_outcome.get('compact_historical_intervention_generalizability_lines', []))
            artifact.setdefault('compact_historical_intervention_transferability_lines', run_outcome.get('compact_historical_intervention_transferability_lines', []))
            artifact.setdefault('compact_historical_intervention_scalability_lines', run_outcome.get('compact_historical_intervention_scalability_lines', []))
            artifact.setdefault('compact_historical_intervention_robustness_lines', run_outcome.get('compact_historical_intervention_robustness_lines', []))
            artifact.setdefault('compact_historical_intervention_adaptability_lines', run_outcome.get('compact_historical_intervention_adaptability_lines', []))
            artifact.setdefault('compact_historical_intervention_sustainability_lines', run_outcome.get('compact_historical_intervention_sustainability_lines', []))
            artifact.setdefault('compact_historical_intervention_repeatability_lines', run_outcome.get('compact_historical_intervention_repeatability_lines', []))
            artifact.setdefault('compact_historical_intervention_reliability_lines', run_outcome.get('compact_historical_intervention_reliability_lines', []))
            artifact.setdefault('compact_historical_intervention_predictability_lines', run_outcome.get('compact_historical_intervention_predictability_lines', []))
        ...
        if scenario_state.get('historical_pattern_memory'):
            ...
            scenario_state['historical_pattern_memory'].setdefault('review_delegation_readiness_state', run_outcome.get('review_delegation_readiness_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_delegation_readiness_evidence', run_outcome.get('operator_review_delegation_readiness_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_execution_readiness_state', run_outcome.get('review_execution_readiness_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_execution_readiness_evidence', run_outcome.get('operator_review_execution_readiness_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_commitment_readiness_state', run_outcome.get('review_intervention_commitment_readiness_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_commitment_evidence', run_outcome.get('operator_review_intervention_commitment_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_deployment_readiness_state', run_outcome.get('review_intervention_deployment_readiness_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_deployment_evidence', run_outcome.get('operator_review_intervention_deployment_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_effect_reliability_state', run_outcome.get('review_intervention_effect_reliability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_effect_reliability_evidence', run_outcome.get('operator_review_intervention_effect_reliability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_outcome_confidence_state', run_outcome.get('review_intervention_outcome_confidence_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_outcome_confidence_evidence', run_outcome.get('operator_review_intervention_outcome_confidence_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_claim_durability_state', run_outcome.get('review_intervention_claim_durability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_claim_durability_evidence', run_outcome.get('operator_review_intervention_claim_durability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_generalizability_state', run_outcome.get('review_intervention_generalizability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_generalizability_evidence', run_outcome.get('operator_review_intervention_generalizability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_transferability_state', run_outcome.get('review_intervention_transferability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_transferability_evidence', run_outcome.get('operator_review_intervention_transferability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_scalability_state', run_outcome.get('review_intervention_scalability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_scalability_evidence', run_outcome.get('operator_review_intervention_scalability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_robustness_state', run_outcome.get('review_intervention_robustness_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_robustness_evidence', run_outcome.get('operator_review_intervention_robustness_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_adaptability_state', run_outcome.get('review_intervention_adaptability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_adaptability_evidence', run_outcome.get('operator_review_intervention_adaptability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_sustainability_state', run_outcome.get('review_intervention_sustainability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_sustainability_evidence', run_outcome.get('operator_review_intervention_sustainability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_repeatability_state', run_outcome.get('review_intervention_repeatability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_repeatability_evidence', run_outcome.get('operator_review_intervention_repeatability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_reliability_state', run_outcome.get('review_intervention_reliability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_reliability_evidence', run_outcome.get('operator_review_intervention_reliability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_predictability_state', run_outcome.get('review_intervention_predictability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_predictability_evidence', run_outcome.get('operator_review_intervention_predictability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_dependability_state', run_outcome.get('review_intervention_dependability_state', {}))
            scenario_state['historical_pattern_memory'].setdefault('operator_review_intervention_dependability_evidence', run_outcome.get('operator_review_intervention_dependability_evidence', {}))
            scenario_state['historical_pattern_memory'].setdefault('review_intervention_assurability_state', run_outcome.get('review_intervention_assurability_state', {}))
            ...
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_delegation_readiness_lines', run_outcome.get('compact_historical_delegation_readiness_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_execution_readiness_lines', run_outcome.get('compact_historical_execution_readiness_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_commitment_lines', run_outcome.get('compact_historical_intervention_commitment_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_deployment_lines', run_outcome.get('compact_historical_intervention_deployment_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_effect_reliability_lines', run_outcome.get('compact_historical_intervention_effect_reliability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_outcome_confidence_lines', run_outcome.get('compact_historical_intervention_outcome_confidence_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_claim_durability_lines', run_outcome.get('compact_historical_intervention_claim_durability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_generalizability_lines', run_outcome.get('compact_historical_intervention_generalizability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_transferability_lines', run_outcome.get('compact_historical_intervention_transferability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_scalability_lines', run_outcome.get('compact_historical_intervention_scalability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_robustness_lines', run_outcome.get('compact_historical_intervention_robustness_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_adaptability_lines', run_outcome.get('compact_historical_intervention_adaptability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_sustainability_lines', run_outcome.get('compact_historical_intervention_sustainability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_repeatability_lines', run_outcome.get('compact_historical_intervention_repeatability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_reliability_lines', run_outcome.get('compact_historical_intervention_reliability_lines', []))
            scenario_state['historical_pattern_memory'].setdefault('compact_historical_intervention_predictability_lines', run_outcome.get('compact_historical_intervention_predictability_lines', []))
    ...
    def _ensure_run_outcome_defaults(self, run_outcome: dict) -> dict:
        ...
        run_outcome.setdefault('review_delegation_readiness_state', {})
        run_outcome.setdefault('operator_review_delegation_readiness_evidence', {})
        run_outcome.setdefault('review_execution_readiness_state', {})
        run_outcome.setdefault('operator_review_execution_readiness_evidence', {})
        run_outcome.setdefault('review_intervention_commitment_readiness_state', {})
        run_outcome.setdefault('operator_review_intervention_commitment_evidence', {})
        run_outcome.setdefault('review_intervention_deployment_readiness_state', {})
        run_outcome.setdefault('operator_review_intervention_deployment_evidence', {})
        run_outcome.setdefault('review_intervention_effect_reliability_state', {})
        run_outcome.setdefault('operator_review_intervention_effect_reliability_evidence', {})
        run_outcome.setdefault('review_intervention_outcome_confidence_state', {})
        run_outcome.setdefault('operator_review_intervention_outcome_confidence_evidence', {})
        run_outcome.setdefault('review_intervention_claim_durability_state', {})
        run_outcome.setdefault('operator_review_intervention_claim_durability_evidence', {})
        run_outcome.setdefault('review_intervention_generalizability_state', {})
        run_outcome.setdefault('operator_review_intervention_generalizability_evidence', {})
        run_outcome.setdefault('review_intervention_transferability_state', {})
        run_outcome.setdefault('operator_review_intervention_transferability_evidence', {})
        run_outcome.setdefault('review_intervention_scalability_state', {})
        run_outcome.setdefault('operator_review_intervention_scalability_evidence', {})
        run_outcome.setdefault('review_intervention_robustness_state', {})
        run_outcome.setdefault('operator_review_intervention_robustness_evidence', {})
        run_outcome.setdefault('review_intervention_adaptability_state', {})
        run_outcome.setdefault('operator_review_intervention_adaptability_evidence', {})
        run_outcome.setdefault('review_intervention_sustainability_state', {})
        run_outcome.setdefault('operator_review_intervention_sustainability_evidence', {})
        run_outcome.setdefault('review_intervention_repeatability_state', {})
        run_outcome.setdefault('operator_review_intervention_repeatability_evidence', {})
        run_outcome.setdefault('review_intervention_reliability_state', {})
        run_outcome.setdefault('operator_review_intervention_reliability_evidence', {})
        run_outcome.setdefault('review_intervention_predictability_state', {})
        run_outcome.setdefault('operator_review_intervention_predictability_evidence', {})
        run_outcome.setdefault('review_intervention_dependability_state', {})
        run_outcome.setdefault('operator_review_intervention_dependability_evidence', {})
        run_outcome.setdefault('review_intervention_assurability_state', {})
        ...
        run_outcome.setdefault('compact_historical_delegation_readiness_lines', [])
        run_outcome.setdefault('compact_historical_execution_readiness_lines', [])
        run_outcome.setdefault('compact_historical_intervention_commitment_lines', [])
        run_outcome.setdefault('compact_historical_intervention_deployment_lines', [])
        run_outcome.setdefault('compact_historical_intervention_effect_reliability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_outcome_confidence_lines', [])
        run_outcome.setdefault('compact_historical_intervention_claim_durability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_generalizability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_transferability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_scalability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_robustness_lines', [])
        run_outcome.setdefault('compact_historical_intervention_adaptability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_sustainability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_repeatability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_reliability_lines', [])
        run_outcome.setdefault('compact_historical_intervention_predictability_lines', [])
    ...
    def _ensure_scenario_insight_defaults(self, scenario_insight_report: dict) -> dict:
        ...
        scenario_insight_report.setdefault('review_delegation_readiness_state', {})
        scenario_insight_report.setdefault('operator_review_delegation_readiness_evidence', {})
        scenario_insight_report.setdefault('review_execution_readiness_state', {})
        scenario_insight_report.setdefault('operator_review_execution_readiness_evidence', {})
        scenario_insight_report.setdefault('review_intervention_commitment_readiness_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_commitment_evidence', {})
        scenario_insight_report.setdefault('review_intervention_deployment_readiness_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_deployment_evidence', {})
        scenario_insight_report.setdefault('review_intervention_effect_reliability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_effect_reliability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_outcome_confidence_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_outcome_confidence_evidence', {})
        scenario_insight_report.setdefault('review_intervention_claim_durability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_claim_durability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_generalizability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_generalizability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_transferability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_transferability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_scalability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_scalability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_robustness_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_robustness_evidence', {})
        scenario_insight_report.setdefault('review_intervention_adaptability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_adaptability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_sustainability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_sustainability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_repeatability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_repeatability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_reliability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_reliability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_predictability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_predictability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_dependability_state', {})
        scenario_insight_report.setdefault('operator_review_intervention_dependability_evidence', {})
        scenario_insight_report.setdefault('review_intervention_assurability_state', {})
        ...
        scenario_insight_report.setdefault('compact_historical_delegation_readiness_lines', [])
        scenario_insight_report.setdefault('compact_historical_execution_readiness_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_commitment_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_deployment_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_effect_reliability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_outcome_confidence_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_claim_durability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_generalizability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_transferability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_scalability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_robustness_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_adaptability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_sustainability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_repeatability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_reliability_lines', [])
        scenario_insight_report.setdefault('compact_historical_intervention_predictability_lines', [])
    ...
    def _world_comparison_summary(self, world: dict) -> dict:
        ...
        return {
            ...
            'service_backlog_index': metrics.get('service_backlog_index', 0.0),
            'delayed_recovery_pressure': metrics.get('delayed_recovery_pressure', 0.0),
            'causal_diagnostics': metrics.get('causal_diagnostics', {}),
